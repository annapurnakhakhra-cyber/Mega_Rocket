        ...
        <div className={`h-16 bg-gradient-to-r from-blue-50 to-indigo-50 shadow-lg border-b border-gray-200 px-4 flex items-center justify-between transition-all duration-300 ease-in-out`}>
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="flex sm:hidden">
                    <button
                        className="p-2 hover:bg-white/60 rounded-lg transition-all duration-200 cursor-pointer shadow-sm cursor-pointer"
                ...
                {isLoggedIn && (
                    <div className="flex sm:hidden">
                        <button
                            onClick={handleLogout}
                            className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white text-sm font-medium rounded-lg hover:bg-red-600 transition-colors duration-200 shadow-md cursor-pointer"
                            title="Logout"
                        >
                            <LogOut className="w-4 h-4" />
                            Logout
