...
const QrCodeOverlay = ({ totalPayable, onGoBack, onOrderPlace, isLoading }) => {
    ...
    return (
        <div className="space-y-6 text-center">
            <button 
                onClick={onGoBack}
                className="flex items-center text-gray-500 hover:text-gray-800 transition duration-150 cursor-pointer"
            ...
            {paymentStatus === 'pending' && (
                 <button
                    ...
                    className="w-full bg-green-600 text-white p-3 rounded-lg font-bold text-lg hover:bg-green-700 disabled:bg-gray-400 flex items-center justify-center shadow-lg cursor-pointer"
                >
                    {isLoading ? (
                        <>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border p-4 rounded-lg shadow-sm space-y-2">
                ...
                <div className="flex space-x-2">
                    ...
                    <button
                        ...
                        className={`p-2 rounded-lg font-semibold text-white transition duration-150 cursor-pointer ${
            ...
            <button
                ...
                disabled={isLoading}
                className={`w-full text-white p-3 rounded-lg font-bold text-lg shadow-lg flex items-center justify-center cursor-pointer ${buttonBg}`}
            >
                {isLoading ? (
                    <>
                        <FontAwesomeIcon icon={faSpinner} spin className="mr-2" />
