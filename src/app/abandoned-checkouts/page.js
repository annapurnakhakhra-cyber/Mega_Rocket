  ...
  const handleExportToExcel = () => {
    ...
    const csvContent = [
      ...
      ...filteredCheckouts.map((c) => {
        const customerName =
          `${c.customer?.firstName || c.address?.firstName || ""} ${c.customer?.lastName || c.address?.lastName || ""}`.trim() || "N/A";
        ...
        return [
          ...
          c.address?.phone || c.customer?.phone || "N/A",
          c.status || "N/A",
                    ...
                    <tr key={c._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm">
                        <div className="space-y-1">
                          ...
                          {(c.address?.phone || c.customer?.phone) && (
                      ...
                      <td className="px-6 py-4 text-center">
                        <button
                          onClick={() => openModal(c)}
                          className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium cursor-pointer"
                        >
          ...
          {filteredCheckouts.map((c) => {
            ...
            return (
              <div key={c._id} className="bg-white rounded-lg shadow-sm p-4">
                ...
                <button
                  onClick={() => openModal(c)}
                  className="w-full py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium cursor-pointer"
                >
                  View Details
                </button>
              </div>
              ...
              >
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <button className="mt-3 px-4 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 cursor-pointer">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div className="space-y-4 text-right pr-4">
                        ...
                        <div className="flex justify-between gap-12">
                          ...
                          <span className="font-medium">
                            {selectedCheckout.shippingLine?.price === 0 || selectedCheckout.pricing?.shipping?.price === 0 ? (
                              <span className="text-green-600 font-bold text-lg">Free</span>
                            ) : (
                              <>₹{(selectedCheckout.shippingLine?.price || selectedCheckout.pricing?.shipping?.price || 0).toLocaleString()}</>
                            )}
                          </span>
                        </div>

                        {/* TAXES - Improved with multiple fallbacks */}
                        <div className="flex justify-between gap-12">
                          <span className="text-gray-600">Taxes (included)</span>
                          <span className="font-medium opacity-50">
                            {(() => {
                              // Try every possible tax field from your data
                              const taxAmount =
                                selectedCheckout.totalTax ??
                                selectedCheckout.pricing?.tax?.amount ??
                                selectedCheckout.pricing?.tax?.shopMoney?.amount ??
                                selectedCheckout.pricing?.tax?.shopMoney?.amount ?? 0;
                        ...
                        {(() => {
                          const subtotal = Number(selectedCheckout.cart?.subtotal || selectedCheckout.pricing?.subtotal || 0);
                          const shipping = Number(selectedCheckout.shippingLine?.price || selectedCheckout.pricing?.shipping?.price || 0);
                          const tax = Number(selectedCheckout.totalTax || 0);
                          const total = subtotal + shipping + tax;
                      ...
                      <div className="space-y-2 mt-6">
                        ...
                        {notesLoading && <p className="text-sm text-gray-400">Loading notes...</p>}
                        {!notesLoading && notes.length === 0 && <p className="text-sm text-gray-400">No notes added yet</p>}
                        {notes.map((n) => (
                          <div key={n._id} className="bg-blue-50 border border-blue-100 rounded-md p-3">
                              ...
                              <p className="text-xs text-gray-500">
                                ...
                                {(() => {
                                  try {
                                    ...
                                    return typeof n.email === "string" ? n.email : "Unknown";
                                  }
                                })()}
                              </p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-4">
                          <p className="font-medium text-gray-900">
                            {selectedCheckout.customer
                              ? `${selectedCheckout.customer.firstName || ""} ${selectedCheckout.customer.lastName || ""}`.trim() || "Guest Customer"
                              : `${selectedCheckout.address?.firstName || ""} ${selectedCheckout.address?.lastName || ""}`.trim() || "Guest Customer"}
                          </p>
                          ...
                          <div className="mt-4 space-y-4">
                            <div>
                              ...
                              {(selectedCheckout.address?.phone || selectedCheckout.customer?.phone) && (
                                <p className="text-sm text-gray-700 mt-2 flex items-center gap-1">
                                  <Phone className="w-4 h-4" />
                                  <a href={`tel:${selectedCheckout.address?.phone || selectedCheckout.customer?.phone}`}>
                                    {selectedCheckout.address?.phone || selectedCheckout.customer?.phone}
                                  </a>
                                </p>
                              )}
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900 leading-relaxed">
                                {(selectedCheckout.address?.firstName || selectedCheckout.customer?.firstName || "")}{" "}
                                {(selectedCheckout.address?.lastName || selectedCheckout.customer?.lastName || "")}
                                <br />
                                {selectedCheckout.address?.address1 || "N/A"}
                                <br />
                                {selectedCheckout.address?.address2 && (
                                  <>
                                    {selectedCheckout.address.address2}
                                    <br />
                                  </>
                                ...
                                {selectedCheckout.address?.province || selectedCheckout.address?.provinceCode || ""}
                                <br />
                                India
                                {selectedCheckout.address?.zip ? ` - ${selectedCheckout.address.zip}` : ""}
                              </p>
                            </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          ...
                          className="w-full py-2 bg-gray-800 text-white rounded hover:bg-gray-900 font-medium disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                        >
                ...
                <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 flex justify-end">
                  <button
                    ...
                    className={`px-8 py-3 rounded font-medium flex items-center gap-2 transition-colors cursor-pointer ${creatingOrder
